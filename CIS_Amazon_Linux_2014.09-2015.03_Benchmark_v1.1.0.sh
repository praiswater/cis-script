...
if [ "$PROFILE" = "Level 1" ] || [ "$PROFILE" = "Level 2" ]; then
  ...
  # Verify Amazon GPG Key is Installed
  echo
  echo \*\*\*\* Verify\ Amazon\ GPG\ Key\ is\ Installed
  ...
  echo
  echo \*\*\*\* The X\ Window\ System is requried for interactive computing and will not be removed for busenss reasons
